        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="user_messages_vocaux.html">Messages vocaux</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="user_plan_appel.html">Plan d'appel</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="user_gestion_conference.html">Conférences</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="creation_gestion_contexte.html">Contexte</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                <br/>
                                    <h1 class="section-heading">Espace Personnel</h1>
                                </div>
                            </div>
